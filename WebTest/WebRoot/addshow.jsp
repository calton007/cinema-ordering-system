...
<table border="1" align="center" cellpadding="10" cellspacing="10" >
 <tr>
    ...
    <td align="center" valign="middle"><table width="95%" border="0" cellspacing="0" cellpadding="0">
      <form name="form1" action="addshow" method="post">
      <tr>
          <td width="23%" height="22" align="right" class="font2">编号和列表中一致</td>
          <td width="77%" height="22" align="left"><input name="ID" type="text" class="textbox" id="ID" /></td>
        </tr>
        <tr>
