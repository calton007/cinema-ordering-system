...
public class delServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
      ...
      req.setCharacterEncoding("UTF-8");
		...
		if(req.getParameter("uid").equals("1"))
		{
			Cinema c=new Cinema();
			c.setId(id);
		...
		else if(req.getParameter("uid").equals("2"))
		{
			HCinema c=new HCinema();
			c.setId(id);
			HCinemaService CS=new HCinemaServiceImp();
			CS.deleteFilm(c);
		}
		else 
		{
			StarCinema c=new StarCinema();
			c.setId(id);
			StarCinemaService CS=new StarCinemaServiceImp();
			CS.deleteFilm(c);
		}
